...
class UpdateLectureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type'               => ['required','string','in:Cultural,Economic,Educational,Historical,Philosophical,Political,Religious,Scientific,Social,Technical,',],

            // ثقافية,تربوية,دينية,اجتماعية,اقتصادية,علمية,فلسفية,تقنية,تاريخية,سياسية
