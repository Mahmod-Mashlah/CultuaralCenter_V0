...
class UpdateLectureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'name'               => ['unique:lectures,name','max:255',],
            'type'               => ['string','in:ثقافية,تربوية,دينية,اجتماعية,اقتصادية,علمية,فلسفية,تقنية,تاريخية,سياسية',],
            'start_date'         => ['date'/*,'date_format:j-n-Y'*/,'after:1-8-2023'],
