...
<html lang="en">
<head>
	<title>Login || Cultural Center</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter ">
       ...
       <div class="container bg-image" >
        ...
        <div class="wrap-login100 bg-dark to-center ">
            <form class="login100-form validate-form ">
                <span class="login100-form-logo ">

                        <img src="{{ asset('assets/img/culture-center-logo.jpg') }}" alt="AdminLTE Logo" class="img-thumbnail brand-image img-circle elevation-3 radius " style="opacity: .8" width='150px' height= '100px' border-radius= '0.50rem'>
